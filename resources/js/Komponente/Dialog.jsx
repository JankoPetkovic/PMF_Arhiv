...
export default function Dialog({naslov, slika = null, sadrzaj, prikaziDialog, podesiPrikaziDialog}) {
    ...
    return (
        ...
        >
            <div ref={prozor} className="transform w-[95vw] sm:w-auto flex-col rounded-xl items-center justify-center shadow-[0px_-8px_12px_rgba(0,0,0,0.2),_0px_8px_20px_rgba(0,0,0,0.3)]">
